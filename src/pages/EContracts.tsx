    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="ml-0 sm:ml-64 mt-16 p-4 sm:p-8">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">E-Contract Hub</h1>
          ...
          {activeTab === 'create' && (
            <div className="p-4 sm:p-8">
              <div className="max-w-3xl mx-auto">
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-4 sm:p-8 mb-6 sm:mb-8">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    <div className="p-2 sm:p-3 bg-green-700 rounded-lg">
                      <Plus className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                    </div>
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Create New E-Contract</h2>
                  </div>
                  <p className="text-sm sm:text-base text-gray-600">
                ...
                <form className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <button
                      type="button"
                      className="flex-1 bg-gray-200 text-gray-700 py-2 sm:py-3 px-4 rounded-lg text-sm sm:text-base font-semibold hover:bg-gray-300 transition-colors"
                    >
                      Save as Draft
                    </button>
                    <button
                      type="submit"
                      className="flex-1 bg-green-700 text-white py-2 sm:py-3 px-4 rounded-lg text-sm sm:text-base font-semibold hover:bg-green-800 transition-colors"
                    >
