    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="ml-0 sm:ml-64 mt-16 p-4 sm:p-8">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Simulate a Hedge</h1>
          <p className="text-sm sm:text-base text-gray-600">Practice hedging strategies without any real-world risk.</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="lg:col-span-2 bg-white rounded-xl shadow-md p-4 sm:p-8">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-base sm:text-lg"
                >
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`flex-1 py-2.5 sm:py-3 px-4 rounded-lg font-semibold transition-all ${
                        position === 'sell'
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      placeholder="e.g., 100"
                      className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-base sm:text-lg"
                    />
                    <select
                      value={unit}
                      onChange={(e) => setUnit(e.target.value)}
                      className="w-full sm:w-auto px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-base"
                    >
              ...
              <button
                ...
                className="w-full bg-green-700 text-white py-3 sm:py-4 rounded-lg font-bold text-base sm:text-lg hover:bg-green-800 transition-colors shadow-lg flex items-center justify-center gap-2"
              >
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            {/* Order Summary */}
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl shadow-md p-4 sm:p-6 border border-amber-200">
              <h3 className="text-lg font-bold text-gray-800 mb-4">Order Summary</h3>

              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-600">Action:</span>
                  <span className={`font-semibold ${position === 'sell' ? 'text-red-600' : 'text-green-600'}`}>
      ...
      {showConfirmation && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 max-w-md w-full shadow-2xl animate-scale-up">
            <div className="text-center">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2">Trade Confirmed!</h3>
