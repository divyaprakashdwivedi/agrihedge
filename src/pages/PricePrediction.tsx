    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="ml-0 sm:ml-64 mt-16 p-4 sm:p-8">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Price Prediction Detail</h1>
          <p className="text-sm sm:text-base text-gray-600">AI-driven price forecasts for your commodities.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-4 sm:p-8">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-4">
                <div>
                  ...
                  <div className="flex flex-wrap items-baseline gap-2 sm:gap-3 mt-2">
                    ...
                    <div className="flex items-center gap-1">
                      <TrendingUp className={`w-4 sm:w-5 h-4 sm:h-5 ${isPositive ? 'text-green-600' : 'text-red-600'}`} />
                      <span className={`text-base sm:text-lg font-semibold ${isPositive ? 'text-green-600' : 'text-red-600'}`}>
                        {isPositive ? '+' : ''}₹{currentCommodity.change.toFixed(2)} ({currentCommodity.percentage}%)
                      </span>
                    </div>
                    <span className="text-sm sm:text-base text-gray-500">/ Quintal</span>
                  </div>
                </div>
                ...
                <select
                  ...
                  className="w-full sm:w-auto px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                >
              ...
              <div className="flex flex-wrap gap-2 mb-4 sm:mb-6">
                {(['30', '60', '90'] as const).map((days) => (
                  <button
                    ...
                    className={`flex-1 sm:flex-none px-4 sm:px-6 py-2 text-sm sm:text-base rounded-lg font-semibold transition-all ${
                      timeframe === days
              ...
              <div className="relative h-72 sm:h-96 bg-gradient-to-b from-green-50 to-white rounded-lg p-3 sm:p-6">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-4 sm:p-6">
              <div className="flex items-center gap-2 mb-3 sm:mb-4">
                <AlertTriangle className="w-4 sm:w-5 h-4 sm:h-5 text-blue-600" />
                <h3 className="text-base sm:text-lg font-bold text-gray-800">AI Rationale</h3>
              </div>
